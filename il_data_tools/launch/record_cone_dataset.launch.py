...
def generate_launch_description():
    args = [
        ...
        declare("session_name", "cone", "Session base name. With auto increment, cone becomes cone_01, cone_02, ..."),
        ...
        declare("default_mission_label", "cone_drive", "Label to use when no label topic is received."),
