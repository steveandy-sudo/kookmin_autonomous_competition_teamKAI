...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "shortcut_yellow_count_pass_target", default_value="2"
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "cone_approach_confirmed_distance_m", default_value="1.15"
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "vehicle_green_car_clear_hold_sec", default_value="0.60"
            ),
            ...
            DeclareLaunchArgument(
                "vehicle_avoidance_straight_pure_pursuit_weight",
                default_value="0.45",
            ),
            DeclareLaunchArgument(
            ...
            Node(
                ...
                parameters=[
                    ...
                    rule_real,
                    {
                        ...
                        "avoidance_active_state_timeout_sec": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_return_diagnostics_timeout_sec"
                            ),
                            value_type=float,
                        ),
                        "avoidance_active_straight_pure_pursuit_weight": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_avoidance_straight_pure_pursuit_weight"
                            ),
                            value_type=float,
                        ),
                        "avoidance_right_entry_opposed_steering_guard_sec": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_avoidance_right_entry_opposed_steering_guard_sec"
                            ),
                            value_type=float,
            ...
            Node(
                ...
                parameters=[
                    cone_config,
                    {
                        ...
                        "cone_yolo_min_confidence": ParameterValue(
                            LaunchConfiguration(
                                "cone_approach_yolo_min_confidence"
                            ),
                            value_type=float,
            ...
            Node(
                ...
                parameters=[
                    hybrid_config,
                    {
                        ...
                        "cone_approach_confirmed_distance_m": ParameterValue(
                            LaunchConfiguration(
                        ...
                        "s_curve_entry_speed_cap_start_distance_m": ParameterValue(
                            LaunchConfiguration(
                                "s_curve_entry_speed_cap_start_distance_m"
                            ),
                            value_type=float,
                        ...
                        "vehicle_green_car_retrigger_required_frames": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_green_car_retrigger_required_frames"
                            ),
                            value_type=int,
                        ),
                        "vehicle_active_side_reselection_offset_rate_mps": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_active_side_reselection_offset_rate_mps"
                            ),
                            value_type=float,
                        ...
                        "vehicle_avoidance_right_settle_speed_limit_command": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_avoidance_right_settle_speed_limit_command"
                            ),
                            value_type=float,
                        ),
                        "vehicle_avoidance_right_settle_tolerance_m": ParameterValue(
                            LaunchConfiguration(
                                "vehicle_avoidance_right_settle_tolerance_m"
                            ),
                            value_type=float,
                        ...
                        "vehicle_green_car_clear_hold_sec": ParameterValue(
                            LaunchConfiguration(
