...
def test_reverse_preserves_path_curvature(calibration):
    ...
    assert command.speed_command == pytest.approx(-3.0)
...
def test_motor_shadow_round_trip_preserves_twist(calibration):
    requested_linear = -0.24
    requested_angular = 0.24
