...
class HybridAStarConfig:
    # Worst measured steering side: max left curvature 1.502435 1/m.
    minimum_turning_radius_m: float = 0.67
    primitive_length_m: float = 0.15
    collision_sample_step_m: float = 0.025
    xy_quantization_m: float = 0.10
    yaw_bins: int = 72
    # Physical 45 mm body clearance plus one 50 mm map/localization cell,
    # matching both Nav2 costmaps. The independent scan shield uses the
    # physical portion because it operates directly in the live base frame.
