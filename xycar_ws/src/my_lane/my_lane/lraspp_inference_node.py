...
class LrasppInferenceNode(Node):
    ...
    def __init__(self) -> None:
        ...
        package_share = Path(get_package_share_directory("my_lane"))
        ...
        self.declare_parameter("src_tl_x_ratio", 0.442578)
        self.declare_parameter("src_tl_y_ratio", 0.480781)
        self.declare_parameter("src_tr_x_ratio", 0.688281)
        self.declare_parameter("src_tr_y_ratio", 0.480781)
        self.declare_parameter("src_br_x_ratio", 0.919141)
        self.declare_parameter("src_br_y_ratio", 0.614189)
        self.declare_parameter("src_bl_x_ratio", 0.190625)
        self.declare_parameter("src_bl_y_ratio", 0.614189)
        self.declare_parameter("dst_left_ratio", 0.205714)
        self.declare_parameter("dst_right_ratio", 0.794286)
