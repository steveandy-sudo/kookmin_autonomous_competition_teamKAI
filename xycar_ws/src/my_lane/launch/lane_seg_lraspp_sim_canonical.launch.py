        ...
        [
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    # Match the real low-latency runtime. Only the Gazebo
                    # camera homography below remains sensor-specific.
                    "debug_rate_hz": "0.0",
                    "max_output_rate_hz": "10.0",
                    ...
                    "canonical_yellow_normalize_line_width_px": "5",
                }.items(),
            )
        ]
    )
