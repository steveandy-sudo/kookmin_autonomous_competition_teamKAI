...
prompt_float SHORTCUT_SPATIAL_GATE_MINIMUM_DISTANCE_M \
  "지름길 조향 시작 최소 분기점 거리 [m]" 0.25 0.0 5.0

prompt_float SHORTCUT_SPATIAL_GATE_BLEND_DISTANCE_M \
  "지름길 RULE-W1 조향 혼합 거리 [m]" 0.25 0.01 5.0
...
prompt_float STRAIGHT_PATH_CURVATURE_THRESHOLD \
  "직선/곡선 곡률 기준 [rad/m]" 0.16 0.0 5.0
prompt_float STEERING_CURRENT_WEIGHT \
  "직선 조향 현재값 비율" 0.40 0.0 1.0
prompt_float STEERING_CURVE_CURRENT_WEIGHT \
  "곡선 조향 현재값 비율" 0.70 0.0 1.0
...
echo "지름길 조향 시작 최소 분기점 거리: ${SHORTCUT_SPATIAL_GATE_MINIMUM_DISTANCE_M}m"
echo "지름길 RULE-W1 조향 혼합 거리: ${SHORTCUT_SPATIAL_GATE_BLEND_DISTANCE_M}m"
...
export SHORTCUT_SPATIAL_GATE_MINIMUM_DISTANCE_M
export SHORTCUT_SPATIAL_GATE_BLEND_DISTANCE_M
