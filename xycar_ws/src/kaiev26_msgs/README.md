...
KAIEV26 SITL에서 사용하는 ROS 2 custom message 패키지입니다.
...
```text
std_msgs/Header header
kaiev26_msgs/RoadSegment[] segments
```
...
```text
std_msgs/Header header
kaiev26_msgs/PerceptionObject[] objects
```
...
```text
std_msgs/Header header
kaiev26_msgs/TrafficLightObservation[] lights
```
